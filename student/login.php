...
{
    if(isset($_SESSION['input_value_l'][$name]))
    {
        return $_SESSION['input_value_l'][$name];
    }
}
    ...
    <div class="page-body animated slideInDown">
        <div class="logo">
            ...
            <?php if(isset($_SESSION['status_err'])) { ?>
                <div class="alert alert-warning alert-dismissible text-center" role="alert">
                    <?php echo $_SESSION['status_err']; ?>
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
            <?php unset($_SESSION['status_err']); } ?>
        </div>
        <div class="box">
                    ...
                    <form method="POST" action="action.php">
                        <div class="form-group mt-md">
                            ...
                            <?php if(isset($_SESSION['login_err']['email'])) { ?>
                                <div style="color:red;font-style:italic; font-weight:bold;"><?= $_SESSION['login_err']['email']; ?></div>
                            <?php } ?>
                        ...
                        <div class="form-group">
                            ...
                            <?php if(isset($_SESSION['login_err']['password'])) { ?>
                                <div style="color:red;font-style:italic; font-weight:bold;"><?= $_SESSION['login_err']['password']; ?></div>
                            <?php } ?>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <input type="submit" value="Sing in" class="btn btn-primary btn-block" name="sign_in">
                        </div>
